...
export const StandardGrid = () => {
  const { mainDeck, extraDeck, sideDeck, removeCard, density } = useBuilderStore();
  ...
  // Density Logic
  // Standard: mobile 4 cols, desktop 8 cols
  // High: mobile 5 cols, desktop 10 cols?
          ...
          <div className={`grid ${gridClass} animate-in fade-in duration-300`}>
            {currentDeck.map((card) => (
              <div key={card.instanceId} className="relative group aspect-[2/3] transform transition-transform hover:scale-105 hover:z-10">
                 ...
                 <div className="w-full h-full rounded-sm overflow-hidden border border-navy-800 shadow-sm group-hover:border-cyan-500 group-hover:shadow-[0_0_10px_rgba(8,217,214,0.3)] transition-all">
